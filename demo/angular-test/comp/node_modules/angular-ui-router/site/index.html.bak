  ...
  <script type="text/javascript">
    ...
    (function() {
      ...
      addTag('link', {rel: 'stylesheet', href: 'css/animations.css', type: 'text/css'});
         ...
         addTag('link', {rel: 'stylesheet', href: 'css/uirouter-docs.css', type: 'text/css'}, sync);
...
<body>
  <header class="header">
	...
	<li><a href="https://github.com/angular-ui/ui-router"><i class="icon-github icon-white"></i> Github</a></li>
	<li><a href="https://github.com/angular-ui/ui-router/wiki"><i class="icon-book icon-white"></i> Guide</a></li>
